...
label0= Label(root,text="PHARMACY MANAGEMENT SYSTEM",bg="black",fg="Yellow",font=("Times", 30))
label1=Label(root,text="ENTER ITEM NAME",bg="black",relief="ridge",fg="white",font=("Times", 12),width=25)
entry1=Entry(root , font=("Times", 12))
label2=Label(root, text="ENTER ITEM PRICE",bd="2",relief="ridge",height="1",bg="black",fg="white", font=("Times", 12),width=25)
entry2= Entry(root, font=("Times", 12))
label3=Label(root, text="ENTER ITEM QUANTITY",bd="2",relief="ridge",bg="black",fg="white", font=("Times", 12),width=25)
entry3= Entry(root, font=("Times", 12))
label4=Label(root, text="ENTER ITEM CATEGORY",bd="2",relief="ridge",bg="black",fg="white", font=("Times", 12),width=25)
entry4= Entry(root, font=("Times", 12))
label5=Label(root, text="ENTER ITEM DISCOUNT",bg="black",relief="ridge",fg="white", font=("Times", 12),width=25)
...
button2= Button(root, text="DELETE ITEM", bg="red", fg="black", width =20, font=("Times", 12),command=deleteitem)
